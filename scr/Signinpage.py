...
"")
        ...
        self.label.setGeometry(QtCore.QRect(170, 120, 181, 31))
...
"")
        ...
        self.line.setGeometry(QtCore.QRect(180, 150, 151, 16))
...
"font: 75 11pt \"Times New Roman\";")
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "New User Sign-In"))
    ...
    def signin(self):
        ...
        try:
            firebase_response = auth.create_user_with_email_and_password(email, password)
            user_email = firebase_response.get("email", "unknown_user")
            self.close() 
            self.open_dashboard(user_email)
        except:
            self.error.setText("Email Already Exits Try Different")
            self.error.setVisible(False)
